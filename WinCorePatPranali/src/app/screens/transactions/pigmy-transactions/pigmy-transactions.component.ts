...
@Component({
  selector: 'app-pigmy-transactions',
  templateUrl: './pigmy-transactions.component.html',
  styleUrls: ['./pigmy-transactions.component.css']
})
export class PigmyTransactionsComponent implements OnInit {
